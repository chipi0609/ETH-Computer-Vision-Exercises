...
bbox = [0.3 -0.2 -2; 2.1 1.1 2.5]; % [minX minY minZ; maxX maxY maxZ];
volumeX = 64;
volumeY = 64;
volumeZ = 128;
volumeThreshold = 17;
...
if computeVisualHull
    ...
    % Project voxel to world coordinates
    for n = 1: numCameras
        for i = 1:volumeX
            for j = 1:volumeY
                for k = 1:volumeZ
                    projection = Ps{n} * T * [i,j,k,1]';
                    projection = floor(projection ./ projection(3));
